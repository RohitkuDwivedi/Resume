<link href="vender/bs/bootstrap.min.css" rel="stylesheet" type="text/css"/>
<script src="vender/jquery-3.2.1.min.js"></script>
<script src="vender/bs/bootstrap.min.js"></script>
...
<h1>
    WE TRANSFORM WORK LIVES.
        ...
        <p>Our family of BOLD solutions help jobseekers and employers. Our online destinations provide unique solutions that help people find jobs, and employers find people. Each one of our unique brands is dedicated to making a meaningful, positive impact on the lives and careers of our customers, and our hard-working employees.

With cv-maker.org we want to provide a professional resume building service. Our tool is based on a friendly user interface, allowing users to create a well-written resume in a few steps.

        <p>As unique "selling points" with which we want to differentiate our proposal, offering:</p>
